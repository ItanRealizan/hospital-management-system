    ...
    return (
        <div className="crud">
            ...
            <main className="crud-body">
                <button className="btn btn-primary mb-3 mr-2" onClick={openAddPatientModal} style={{ fontFamily: 'Arial, sans-serif' }}>Add Patient</button>
                    ...
                    <tbody>
                        {patients.map((patient) => (
                            <tr key={patient.id}>
                                ...
                                <td>
                                    <button className="btn btn-info mr-2" onClick={() => openViewPatient(patient)} type="button" style={{ fontFamily: 'Arial, sans-serif' }}>
                                        View
                                    </button>
                                    <button className="btn btn-primary mr-2" onClick={() => openEditPatient(patient)} type="button" style={{ fontFamily: 'Arial, sans-serif' }}>
                                        Edit
                                    </button>
                                    <button className="btn btn-secondary" onClick={() => openDeletePatient(patient)} type="button" style={{ fontFamily: 'Arial, sans-serif' }}>
                                        Delete
                                    </button>
                                </td>
                            </tr>
                        ...
                        <form onSubmit={submitEditedPatient}>
                            <div className="modal-dialog" role="document">
                                <div className="modal-content">
                                    ...
                                    <div className="modal-footer">
                                        <button type="submit" className="btn btn-success" style={{ fontFamily: 'Arial, sans-serif' }}>Save</button>
                                        <button type="button" className="btn btn-secondary" onClick={handleCloseModal} style={{ fontFamily: 'Arial, sans-serif' }}>Close</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                        ...
                        <form onSubmit={submitDeletedPatient}>
                            <div className="modal-dialog" role="document">
                                <div className="modal-content">
                                    ...
                                    <div className="modal-footer">
                                        <button type="submit" className="btn btn-danger" style={{ fontFamily: 'Arial, sans-serif' }}>Yes</button>
                                        <button type="button" className="btn btn-secondary" onClick={handleCloseModal} style={{ fontFamily: 'Arial, sans-serif' }}>No</button>
                                    </div>
                                </div>
                            </div>
                        </form>
